...
@section('content')
    ...
    <div class="row">
        ...
        <div class=" btn-group-justified m-b-10">
            <a href="#add" class="btn btn-success waves-effect btn-lg waves-light" data-animation="fadein" data-plugin="custommodal"
                data-overlaySpeed="100" data-overlayColor="#36404a">اضافة مدينة <i class="fa fa-plus"></i> </a>
        ...
        <form action="{{route('addcity')}}" method="post" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="field-1" class="control-label">اسم الدولة</label>
                            <select name="country_id" class="form-control">
                                <option value="">أختار الدولة التابعة لها</option>
    ...
    <div id="edit" class="modal-demo">
        ...
        <form action="{{route('updatecity')}}" method="post" autocomplete="off" enctype="multipart/form-data">
            {{csrf_field()}}
        ...
        <div class="custombox-modal-container" style="width: 400px !important; height: 175px;">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <span style="color: red">عند حذف مدينة يتم حذف الأحياء والعقارات التابعة لها !!</span>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
