                ...
                <table id="datatable" class="table table-bordered table-responsives">
                    ...
                    @foreach($users as $user)
                        <tr>
                            ...
                            <td><img src="{{asset('images')}}/users/{{$user->avatar}}" alt="user-img" width="60px" title="Mat Helme" class="img-circle img-thumbnail img-responsive"></td>
                            <td>{{$user->name}}</td>
                            <td>{{$user->email}}</td>
                            <td>{{$user->phone}}</td>
                            <td>
                            ...
                            <td>
                                @if($user->checked == 0)
                                    <div class="checkbox checkbox-custom">
                                        <input type="checkbox" onchange="changeChecked({{$user->id}})" id="activeCheckbox" name="checked" checked value="0" data-plugin="switchery" data-color="#df3c3c" data-switchery="true" style="display: none;">
                                    </div>
                                @else
                                    <div class="checkbox checkbox-custom">
                                        <input type="checkbox" onchange="changeChecked({{$user->id}})" id="activeCheckbox" name="checked" value="" data-plugin="switchery" data-color="#df3c3c" data-switchery="true" style="display: none;">
                                    </div>
                                @endif
                            </td>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="nope" name="name" required class="form-control" placeholder="اسم المستخدم">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="field-2" class="control-label">رقم الهاتف</label>
                            <input type="text" autocomplete="nope" name="phone" required class="form-control phone" placeholder="96600000000">
                        </div>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="field-1" class="control-label">الاسم</label>
                            <input type="text" autocomplete="nope" name="edit_name" value="" required class="form-control" placeholder="اسم المستخدم">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="field-2" class="control-label">رقم الهاتف</label>
                            <input type="text" autocomplete="nope" name="edit_phone" value="" required class="phone form-control" id="phone" placeholder="96600000000">
                        </div>
                    </div>
                </div>
                <div class="row">
