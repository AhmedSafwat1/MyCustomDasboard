                ...
                <div class="container">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <!-- contacts -->
                            @php
                                $unseenCount = App\Models\Contact::unReedMsgs()->count();
                            @endphp
                            <div class="notification-box">
                                <ul class="list-inline m-b-0">
                                    <li>
                                        ...
                                        <div class="noti-dot">
                                            <span @if($unseenCount > 0) id="spanContactCount" @else id="spanContactCountZero" @endif>{{$unseenCount}}</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
    ...
    <!-- ============================================================== -->
        ...
        <div class="content-page" id="Content" style="display:none;">
            ...
            <footer class="footer text-center">
                <div class="row">
                    <div class="col-sm-12">Baayte &copy; {{date("Y")}}</div>
                </div>
            </footer>
